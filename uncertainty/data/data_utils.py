...
def load_ds(dataset_name, seed, add_options=None):
    ...
    if dataset_name == "squad":
        ...
        path = f"/home/hjkim/semantic_uncertainty/webtext.train.jsonl"
        ...
        for question, id in zip(questions, ids):
            ...
            dataset_dict["context"] = [None] * len(dataset_dict["question"])
        ...
        data_path = "/data2/hjkim/megatron_dataset/data/webtext.train.jsonl"
        data_list = []
        ...
        train_dataset = [reformat(d) for d in data_list]
