...
BRIEF_PROMPTS = {
    ...
    'summary': 'Summarize the following text in a single brief but complete sentence.\n',
    'keyword': "Find one keyword of the text as briefly as possible.\n"}
...
def get_parser(stages=['generate', 'compute']):
    ...
    if 'generate' in stages:
        ...
        parser.add_argument(
            ...
            choices=['trivia_qa', 'squad', 'bioasq', 'nq', 'svamp', 'webtext'],
            help="Dataset to use")
        parser.add_argument(
